    ...
    <section className="relative flex flex-col justify-center">
      <div className="max-w-[800px] mx-auto px-6 w-full pt-24 pb-12">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-10">
          ...
          >
            <div className="w-64 sm:w-72 lg:w-[280px] lg:h-[360px] border-2 border-border2 dark:border-white bg-surface overflow-hidden relative group shadow-xl shadow-black/20 hover:border-primary/40 dark:hover:border-white/80 transition-[border-color] duration-300">
