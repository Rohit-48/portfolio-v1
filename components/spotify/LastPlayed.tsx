...
export default function LastPlayed({ track }: LastPlayedProps) {
  return (
    <div>
      {/* Status indicator */}
      <div className="flex items-center gap-2 mb-5">
        <span className="w-1.5 h-1.5 bg-border2 dark:bg-border2" style={{ clipPath: "circle(50%)" }} />
        <span className="font-mono text-[10px] text-dim tracking-label font-medium">
          LAST PLAYED
        </span>
      </div>
